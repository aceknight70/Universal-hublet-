      ...
      try {
        ...
        if (!data) {
          ...
          const fallbackClients: Record<string, any> = {
            'ugomenz': { id: 'fallback-1', name: 'Ugomenz Electronics', slug: 'ugomenz', categories: [], theme: { accent_color: '#E8622C' }, created_at: new Date().toISOString() },
            'o-frank': { id: 'fallback-2', name: 'O Frank Electronics', slug: 'o-frank', categories: [], theme: { accent_color: '#2B5FD9' }, created_at: new Date().toISOString() },
            'allsufficiency': { id: 'fallback-3', name: 'AllSufficiency (ORB)', slug: 'allsufficiency', categories: [], theme: { accent_color: '#C0392B' }, created_at: new Date().toISOString() },
            'linz': { id: 'fallback-4', name: 'Linz Electronics', slug: 'linz', categories: [], theme: { accent_color: '#6F4E37' }, created_at: new Date().toISOString() }
          };
